 ...
 * @author Ezequiel Cao
 */
public class FrmBajas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        PanelPorLegajoLayout.setHorizontalGroup(
            ...
            .addGroup(PanelPorLegajoLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(PanelPorLegajoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtActivo, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBajasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBajasActionPerformed
        ...
        if (this.txtLegajo.getText().isEmpty()) {
            ...
            if (Existe==true) {
                ...
                this.txtActivo.setText(Activo);
                this.txtMNombre.setText(String.valueOf(ObjB.getNom()));
                
                this.txtNroMLeg.setEditable(false);
                this.txtMSueldo.setEditable(false);
                 this.txtMNombre.setEditable(false);
                 this.txtActivo.setEditable(false);
                
                this.btnBajas.setEnabled(false);
            }
